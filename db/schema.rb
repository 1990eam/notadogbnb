...
ActiveRecord::Schema.define(version: 2020_07_24_213816) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["notdog_id"], name: "index_bookings_on_notdog_id"
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.text "answer"
    t.index ["notdog_id"], name: "index_messages_on_notdog_id"
    t.index ["user_id"], name: "index_messages_on_user_id"
  end

  create_table "notdogs", force: :cascade do |t|
    t.string "name"
  ...
  add_foreign_key "messages", "notdogs"
